  ...
  return (
    <section id="skillset" className="relative w-full py-24 bg-[#fdf2f8] overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
        ...
        {/* Section Header */}
        <div className="text-center mb-20 animate-fade-in-up delay-200">
        ...
        <div className="flex flex-col gap-16 md:gap-24">
          {skillCategories.map((category, idx) => (
            <div key={idx} className={`grid lg:grid-cols-12 gap-10 lg:gap-16 items-center animate-fade-in-up ${idx === 0 ? 'delay-300' : idx === 1 ? 'delay-500' : idx === 2 ? 'delay-700' : 'delay-900'}`}>
        ...
        <div className="mt-32 pt-16 border-t border-pink-200/40 animate-fade-in-up delay-1000">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {/* Cert 1 */}
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-6 border border-pink-100/50 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(255,122,156,0.15)] transition-all hover:-translate-y-1 group">
